    ...
    >
      <div className="section-container">
        ...
        <p className="section-subtitle mb-16 opacity-0 fade-in-element">
          A comprehensive automated workflow from data ingestion to production
          deployment
        </p>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {stages.map((stage, index) => (
              ...
              >
                <div className="glass-card p-6 text-center hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="text-xs font-semibold text-pulse-500 mb-2">
                    STAGE {stage.id}
                  </div>
                ...
                {index < stages.length - 1 && (
                  <div className="hidden md:flex justify-center items-center mt-4">
                    <svg
                      className="w-6 h-6 text-pulse-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="mt-16 p-8 bg-gradient-to-br from-pulse-50 to-orange-50 rounded-3xl opacity-0 fade-in-element">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              IntelliModel orchestrates the entire machine learning lifecycle
              through intelligent agents that handle data profiling,
              preprocessing, model selection, training, validation, and
              deployment. The system continuously monitors performance and
              automatically triggers optimization when needed, ensuring your
              models stay accurate and relevant in production environments.
            </p>
          </div>
        </div>
      </div>
